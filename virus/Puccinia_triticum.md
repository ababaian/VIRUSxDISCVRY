...
![Figure 1: First Rows of Table of SRR Observations obtained from Serratus containing our palmprint sequence](img/PtV_images/Figure_1.0.png)
...
![Figure 3: ORF analysis of our full RdRp sequence, using ORF finder tool with default settings](img/PtV_images/Figure_3.0.png) Figure 3: ORF analysis of our full RdRp sequence, using ORF finder tool with default settings
...
![Figure 4: Evolutionary Tree generated by Serraturs using our RdRp sequence](img/PtV_images/Figure_4.0.png) Figure 4: Evolutionary Tree generated by Serraturs using our RdRp sequence
...
![Figure 6: AlphaFold3 (Jumper, J, 2021) Analysis of PtV compared to PsV5](img/PtV_images/Figure_6.png) Figure 6: AlphaFold3 (Jumper, J, 2021) Analysis of PtV compared to PsV5. pIDDT scale indicates confidence in protein structure.
...
![Figure 7: Charged residues of PtV. EMBOSS PepInfo was used for analysis](img/PtV_images/Figure_7.png) Figure 7: Charged residues of PtV. EMBOSS PepInfo was used for analysis. Lines represent areas where a charged residue was found

![Figure 8: Charged residues of PsV5. EMBOSS PepInfo was used for analysis](img/PtV_images/Figure_8.png) Figure 8: Charged residues of PsV5. EMBOSS PepInfo was used for analysis. Lines represent areas where a charged residue was found
...
![Figure 9: PyMol (DeLano D. L, 2002) rendering of PsV5 (already characterized virus simikar to ours), PtV (our virus), and a PtV and PsV5 multimer](img/PtV_images/Figure_9.png) Figure 9: PyMol (DeLano D. L, 2002) rendering of PsV5 (already characterized virus simikar to ours), PtV (our virus), and a PtV and PsV5 multimer. 3D structures were downloaded in .pdb format using AlphaFold2 (Jumper et al, 2021), available on google collab.(<https://colab.research.google.com/github/sokrypton/ColabFold/blob/main/AlphaFold2.ipynb>).
...
![Figure 11: AlphaFold3 (Jumper, J, 2021) analysis of the rRdRp protein encoded by the reverse ORF of PtV](img/PtV_images/Figure_11.png) Figure 11: AlphaFold3 (Jumper, J, 2021) analysis of the rRdRp protein encoded by the reverse ORF of PtV
