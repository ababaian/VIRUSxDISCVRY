...
![](img/Mysticeovirus_mutabilis/SnapGene_Homo_sapiens.png)

**Figure 1a. Genome organization of *Mysticeovirus mutabilis* (human-derived contig).** Linear gene map for the human-derived contig, showing a single long open reading frame (ORF) spanning nucleotides 3–1643 (546 aa). GC content is 46%. The ORF encodes an RNA-dependent RNA polymerase (RdRp), with catalytic motifs A, B, and C annotated along the scale. Nucleotide and rulers are shown for reference. No additional ORFs, frameshifting sites, or poly-A features were detected. Genome boundaries and ORF coordinates were annotated using ORFfinder and visualized with SnapGene.


![](img/Mysticeovirus_mutabilis/SnapGene_Bat_paramyxovirus.png)

**Figure 1b. Genome organization of *Mysticeovirus mutabilis* (bat-derived contig).** Linear gene map for the bat-derived viral contig, showing a single RdRp ORF spanning nucleotides 2–1660 (553 aa). GC content is 41%. Motifs A, B, and C are marked at the corresponding positions, similar to the human-derived sequence. No additional coding features or viral genome segments were identified.
...
![](img/Mysticeovirus_mutabilis/Motif_A_B.png)
...
<p align="center">
  <img src="img/Mysticeovirus_mutabilis/Homo_sapiens_3D_annotated.png" width="500"/>
</p>

**Figure 3a. AlphaFold predicted structure of the *M. mutabilis* RdRp (human isolate)** Motifs A (blue), B (green), and C (red) were annotated using PyMOL following the analysis of conserved sequences. 

<p align="center">
  <img src="img/Mysticeovirus_mutabilis/Bat_paramyxovirus_3D_annotated.png" width="500"/>
</p>

**Figure 3b. AlphaFold predicted structure of the *M. mutabilis* RdRp (bat isolate).** Annotated for motifs A (blue), B (green), and C (red). 
...
![](img/Mysticeovirus_mutabilis/phylogenetic_tree.png)

**Figure 5. Maximum-likelihood phylogenetic tree of RdRp amino acid sequences, including the human-derived *Mysticeovirus mutabilis* sequence.** The *Mysticeovirus mutabilis* clade (red) clusters robustly within a central fungal Partitiviridae lineage. The long internal branch leading to *Mysticeovirus mutabilis* (~0.23 substitutions/site) indicates substantial divergence from known fungal isolates.
