# Symposium Talk - Viral residency: Mapping host-virus interactions of _Dulcivirus diffusus_

### Video Thumbnail

[Video thumbnail](img/D_diffusus/thumbnail.png) 

### Video Description
This oral presentation delves into the idea of "viral residency," where viruses 
can persist across various organisms beyond infection, genome integration, or contamination, as passerby "relics."
Here, Esther walks through the discovery of _Dulcivirus diffusus_, a novel narnavirus, and how 
its genome and structure suggest its mode of residence: by infecting plant-associated fungi, or even plants directly,
and spreading through interacting organisms via environmental deposition. 

presented by: [Esther](https://github.com/esther-git)
project link: [project link](https://github.com/ababaian/VIRUSxDISCVRY/Dulcivirus_diffusus.md>)


Oral presentation walking through the discovery of the _Dulcivirus diffusus_ narnavirus, its structure and characteristics, and mode of residence.
