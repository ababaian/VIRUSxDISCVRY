...
presented by: [Joseph Duraisingh](https://github.com/josephDURAISINGH) project link: [project link](https://github.com/ababaian/VIRUSxDISCVRY/Agricolae-Amicus.md)

Shark Tank pitch for the agricultural applications of a newly discovered mitovirus!
