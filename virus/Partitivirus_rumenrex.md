...
![Figure 1: Phylogenetic Tree with Novel Virus in Evolutionary Context](img/Partitivirus_rumenrex/Phylo1.png)
...
![Figure 2: Data Collected Across Chinese Provinces Contextualizing the Virus](img/Partitivirus_rumenrex/China.png)
...
![Figure 3: Evaluating Viral Sample Site](img/Partitivirus_rumenrex/Site.png)
...
![](img/Partitivirus_rumenrex/Orf.png)

**Circular genome representation and ORF annotation of the *P. rumenrex* assembly.**\
...
![Figure 4: Phylogenetic Tree with Added Rodent-Associated Virus for Further Analysis](images/Partitivirus_rumenrex/Phylo2.png)
...
![Figure 5: RNA Secondary Structure Analysis](img/Partitivirus_rumenrex/RNA.png)
...
![Figure 7: AlphaFold Structure](img/Partitivirus_rumenrex/Alphafold1.png){width="424"}

![Figure 8: AlphaFold Analysis](img/Partitivirus_rumenrex/Alphafold.png)
...
![Figure 9: Hex Code of Novel Virus](img/Partitivirus_rumenrex/Hex.png)
