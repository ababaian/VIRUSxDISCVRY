# Foldseek
written by: [Izumi Ando](https://github.com/izumiando), edited by: [Victoria Pergola](https://github.com/vpergola22) (edits are **bolded**)
...
point to find hints on the characterisitcs of the Oblin the Obelisk encodes and to find 
